<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="./index.php?page=home">Welcome To Online Bus Booking</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block" id='top-nav'>
        <ul>
          <li class="nav-home"><a href="./index.php?page=home">Home</a></li>
           ...
           <li class="nav-schedule"><a href="./admin.php?page=schedule">AdminLogin</a></li>
